    ...
    public class commands
    {
        ...
        public async Task Roulette(CommandContext ctx, int size)
        {
            ...
            else if (size == 8)
            {
                ...
                {
                    Console.WriteLine("not sr or ex");
                    if (bonusSRcheck < 51)
                    {
                        Console.WriteLine("under51");
                        text4 = "*Let's keep this interesting, shall we?*";
                        text3 = "Minimum Item Level";
                        if (bonusSRcheck < 21)
                        {
                            Console.WriteLine("under21");
                            text4 = "*Amuse me.*";
                            text5 = SpecialRules[rng.Next(4, 7)];
                            if (bonusSRcheck < 11)
                            {
                                Console.WriteLine("under11");
                                text4 = "*Feed me.*";
                                text5 = SpecialRules[rng.Next(SpecialRules.Length)];
                            }
                        }
                    }
                    var embed = new DiscordEmbedBuilder();
                    ...
                    {
                        Console.WriteLine("20orunder");
                        embed.AddField("**Special Rules**", "*" + text3 + " and " + text5 + "*", false);
                    }
                    await ctx.RespondAsync("", embed: embed);
                    Console.WriteLine("full8done");

                }
                else if (text == "Savage")
                {
                    Console.WriteLine("is Savage");
                    ...
                    {
                        Console.WriteLine("is not Savage coil");
                        text4 = "*Suffer.*";
                        if (bonusSRcheck < 11)
                        {
                            Console.WriteLine("sav sr is under 11");
                            text4 = "*Despair.*";
                            text3 = "Minimum Item Level";
                        }
                        var embed = new DiscordEmbedBuilder();
                        ...
                        await ctx.RespondAsync("", embed: embed);
                        Console.WriteLine("sav8done");
                    }
                    else
                    {
                        Console.WriteLine("is Savage coil");
                        if (bonusSRcheck > 2)
                        {
                            Console.WriteLine("is not hell");
                            var embed = new DiscordEmbedBuilder();
                            ...
                            await ctx.RespondAsync("", embed: embed);
                            Console.WriteLine("savcoil8done");
                        }
                        else
                        {
                            Console.WriteLine("is hell");
                            var embed = new DiscordEmbedBuilder();
                ...
                else if (text == "StoryRaid")
                {
                    ...
                    if (bonusSRcheck > 24)
                    {
                        Console.WriteLine("sr is over 24");
                        embed.AddField("**Special Rules**", "*" + text3 + "*", false);
                    }
                    else
                    {
                        Console.WriteLine("sr is 24 or under");
                        embed.AddField("**Special Rules**", "*" + text3 + " and " + text5 + "*", false);
                    }
                    await ctx.RespondAsync("", embed: embed);
                    Console.WriteLine("sr8done");
                }
                else if (text == "EX")
                {
                    Console.WriteLine("is EX");
                    randomIndex = rng.Next(DlistEX.GetLength(0));
                    text = DlistEX[randomIndex, 0];
                    text2 = DlistEX[randomIndex, 1];
                    if (bonusSRcheck < 76)
                    {
                        Console.WriteLine("ex sr is under 76");
                        text4 = "*Amuse me.*";
                        text3 = "Minimum Item Level";
                        if (bonusSRcheck < 25)
                        {
                            Console.WriteLine("ex sr is under 25");
                            text4 = "*Feed me.*";
                            text5 = SpecialRules[rng.Next(4, 7)];
                        }
                    }
                    ...
                    if (bonusSRcheck > 24)
                    {
                        Console.WriteLine("ex sr is over 24");
                        embed.AddField("**Special Rules**", "*" + text3 + "*", false);
                    }
                    else
                    {
                        Console.WriteLine("ex sr is 24 or under");
                        embed.AddField("**Special Rules**", "*" + text3 + " and " + text5 + "*", false);
                    }
                    await ctx.RespondAsync("", embed: embed);
                    Console.WriteLine("ex8done");
                }
            }
        }
    }
